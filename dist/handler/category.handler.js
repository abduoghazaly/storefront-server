...
var show = function (_req, _res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, cate.show(+_req.params.id)];
            case 1:
                result = _a.sent();
                _res.json(result);
                return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, cate.create(cateed)];
            case 1:
                result = _a.sent();
                _res.json(result);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, cate.update(cateed)];
            case 1:
                result = _a.sent();
                _res.json(result);
                return [3 /*break*/, 3];
...
var deleted = function (_req, _res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, cate["delete"](+_req.params.id)];
            case 1:
                result = _a.sent();
                _res.json(result);
                return [2 /*return*/];

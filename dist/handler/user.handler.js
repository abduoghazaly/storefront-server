...
var show = function (_req, _res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, users.show(+_req.params.id)];
            case 1:
                result = _a.sent();
                _res.json(result);
                return [2 /*return*/];
...
var update = function (_req, _res) { return __awaiter(void 0, void 0, void 0, function () {
    var newUser, result, token, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, users.update(newUser)];
            case 1:
                result = _a.sent();
                token = jsonwebtoken_1["default"].sign(result, TOKEN_SECRET);
                _res.json({ token: token });
...
var deleted = function (_req, _res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, users["delete"](+_req.params.id)];
            case 1:
                result = _a.sent();
                _res.json(result);
                return [2 /*return*/];
...
var signin = function (_req, _res) { return __awaiter(void 0, void 0, void 0, function () {
    var usered, result, token, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, users.signin(usered)];
            case 1:
                result = _a.sent();
                token = jsonwebtoken_1["default"].sign(result, TOKEN_SECRET);
                _res.json({ token: token });
